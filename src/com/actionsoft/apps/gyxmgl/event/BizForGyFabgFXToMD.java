...
/**
 * 投委会审批流程完成后调用事件
 * com.actionsoft.apps.gyxmgl.event.BizForGyFabgFXToMD
 * @author CHENDX
 *
 */
public class BizForGyFabgFXToMD extends ExecuteListener {
	
	private String XMJL_ROLE = "项目经理";
	private String XMCY_ROLE = "项目成员";
	
	public BizForGyFabgFXToMD(){
		super.setDescription("方案变更（风险）最后环节,将项目信息中项目经理、项目组成员数据备份至主数据[项目干系人表]及更改主数据的项目状态（审核动作与项目阶段流程信息维护相关）");
